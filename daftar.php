...
<table>
 	...
 	<tr><td>Kecamatan </td><td>
 		<select name="Kecamatan">
			...
			<option>Babakan madang</option>
			<option>Parung panjang</option>
			<option>Gunung Putri</option>
			<option>Ciawi</option>
			<option>Cijeruk</option>
			<option>Megamendung</option>
			<option>Ranca bungur</option>
			<option>Tajur halang</option>
